...
public class FourPeaksTest {
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i < iterations; i++)
        {
            SimulatedAnnealing sa = new SimulatedAnnealing(1e4, .925, hcp);
            long t = System.nanoTime();
            FixedIterationTrainer fit = new FixedIterationTrainer(sa, 25000);
            fit.train();
        ...
        for(int i = 0; i < iterations; i++)
        {
            ...
            long t = System.nanoTime();
            FixedIterationTrainer fit = new FixedIterationTrainer(ga, 750);
            fit.train();
        ...
        for(int i = 0; i < iterations; i++)
        {
            MIMIC mimic = new MIMIC(1000, 50, pop);
            
            long t = System.nanoTime();
            FixedIterationTrainer fit = new FixedIterationTrainer(mimic, 750);
            fit.train();
